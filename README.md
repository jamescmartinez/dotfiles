...
1. (Linux only) Run `sudo --preserve-env=HOME brew services start tailscale` to start Tailscale now and at boot.
...
1. Run `fisher update` to install plugins from `~/.config/fish/fish_plugins`
